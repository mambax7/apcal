...
//                    if ($tmpl_type = strtoupper($attributes['type'])) {
                        if ($tmpl_type = isset($attributes['type']) ? strtoupper($attributes['type']) :false) {
                    ...
                    if ($this->depth > 0) {
                        ...
                        if ($placeholder = isset($attributes['placeholder']) ? strtoupper($attributes['placeholder']) :false) {
