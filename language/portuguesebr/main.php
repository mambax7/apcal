...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined('APCAL_MB_LOADED')) {
    ...
    // index.php
    define('_MB_APCAL_ERR_NOPERMTOUPDATE', 'Você não tem autorização para alterar eventos.');
    ...
    define('_MB_APCAL_ERR_NOPERMTOINSERT', 'Você não tem autorização para criar eventos.');
    define('_MB_APCAL_ERR_NOPERMTODELETE', 'Você não tem autorização para apagar eventos.');
