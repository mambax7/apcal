...
define('_APCAL_MB_EVENT_NEEDADMIT','Pendente de aprovação') ;
...
define('_APCAL_TH_ALLDAYOPTIONS','Opções do dia') ;
...
define('_APCAL_NTC_NUMBEROFNEEDADMIT','(%s itens pendentes de aprovação)') ;
...
define('_APCAL_CNFM_SAVEAS_YN','Você deseja realmente salv�-lo como outro registro?') ;
define('_APCAL_CNFM_DELETE_YN','Você deseja realmente apagar este registro?') ;

define('_APCAL_ERR_INVALID_EVENT_ID','ERRO: o não ID não foi encontrado.') ;
define('_APCAL_ERR_NOPERM_TO_SHOW', 'ERRO: você não tem permissão de acesso.') ;
define('_APCAL_ERR_NOPERM_TO_OUTPUTICS', 'ERRO: você não tem permissão para exportar para o iCalendar.') ;
