...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined('_MB_APCAL_BL_LOADED')) {
    ...
    define('_MB_APCAL_EVENTS_AFTER', 'Termine nach dem %s');
    ...
    define('_MB_APCAL_SHOWPICTURES', 'Bilder anzeigen');
    define('_MB_APCAL_YES', 'Ja');
    define('_MB_APCAL_NO', 'Nein');

    define('_MB_APCAL_READMORE', 'Details anzeigen');
    define('_MB_APCAL_EDIT', 'Bearbeiten');
    define('_MB_APCAL_SHOWCAL', 'Veranstaltungskalender anzeigen');
}
