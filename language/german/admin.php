...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined('_AM_APCAL_AM_LOADED')) {
    ...
    define('_AM_APCAL_NBEVENTS', 'Es gibt %s kommende Events.');
    ...
    define('_AM_APCAL_GROUPPERM', 'Gruppen-Berechtigungen');
    ...
    //added 3 lines by goffy2
    define('_AM_APCAL_GPERM_G_RO_ONLINE_REG', 'dürfen Onlineanmeldung verwenden');
    define('_AM_APCAL_GPERM_G_RO_SHOWLIST', 'dürfen Teilnehmerliste ansehen');
    ...
    define('_AM_APCAL_NOTICE_SERVER_TZ', 'Wenn Ihr Server mit Sommerzeit arbeitet und einige Events mit APCal 0.6x or 0.7x erfasst wurden, dann diese Schaltfäche nicht drücken.<br />z.B.) Es ist normal, dass beides (-5.0 und -4.0 zur Sommerzeit) angezeigt wird');
    define('_AM_APCAL_MB_SUCCESSTZUPDATE', 'Events wurden entsprechend der Zeitzone(n) angepasst.');
    ...
    define('_AM_APCALAM_APCALDBUPDATED', 'Datenbank aktualisiert');

    define('_AM_APCAL_UPGRADEFAILED0', "Aktualierung fehlgeschlagen - konnte Feld '%s' nicht umbenennen");
    define('_AM_APCAL_UPGRADEFAILED1', 'Aktualierung fehlgeschlagen - konnte neue Feldér nicht hinzufügen');
    define('_AM_APCAL_UPGRADEFAILED2', "Aktualierung fehlgeschlagen - konnte Tabelle '%s' nicht umbenennen");
    define('_AM_APCAL_ERROR_COLUMN', 'Konnte Spalte in Datenbank nicht erstellen: %s');
    define('_AM_APCAL_ERROR_BAD_XOOPS', 'Dieses Modul benötigt XOOPS %s+ (%s installiert)');
    define('_AM_APCAL_ERROR_BAD_PHP', 'Dieses Modul benötigt PHP Version %s+ (%s installiert)');
    define('_AM_APCAL_ERROR_TAG_REMOVAL', 'Konnte Tags vom Tag-Modul nicht entfernen');

    define('_AM_APCAL_ADMINBLOCK', 'Admin Frontpage');
    define('_AM_APCAL_ALLMODULEPAGES', 'Alle Modulseiten');
    define('_AM_APCAL_ALLPAGES', 'Alle Übersichtsseiten');
    define('_AM_APCAL_CLONEBLOCK', 'Klone Block');
    define('_AM_APCAL_CUSTOMHTML', 'HTML');
    define('_AM_APCAL_CUSTOMNOSMILE', 'Keine Smileys');
    define('_AM_APCAL_CUSTOMPHP', 'PHP');
    define('_AM_APCAL_CUSTOMSMILE', 'Smiley');
    define('_AM_APCAL_DBUPDATED', 'Datenbank aktualisiert');
    define('_AM_APCAL_EDITBLOCK', 'Block bearbeiten');
    define('_AM_APCAL_MODULECANT', 'Dieser Block kann nicht direkt gelöscht werden! Wenn Sie diesen Block deaktivieren wollen, deaktivieren Sie zuerst das Modul.');
    define('_AM_APCAL_RUSUREDEL', 'Sind Sie sicher, dass Sie diesen Block löschen wollen: <b>%s</b>?');
    define('_AM_APCAL_SYSTEM_HELP', 'System-Hilfe');
    define('_AM_APCAL_SYSTEMCANT', 'Systemblöcke können nicht gelöscht werden!');
    define('_AM_APCAL_SYSTEMLEVEL', 'System Level');
    define('_AM_APCAL_TOPPAGE', 'Hauptseite');
}
