...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined('APCAL_MB_LOADED')) {
    ...
    // index.php
    define('_MB_APCAL_ERR_NOPERMTOUPDATE', '�z�S���s�誺�v���I');
    ...
    define('_MB_APCAL_ERR_NOPERMTOINSERT', '�z�S���o���v���I');
    define('_MB_APCAL_ERR_NOPERMTODELETE', '�z�S���R�����v���I');
    define('_MB_APCAL_ALT_PRINTTHISEVENT', '�C�L�Ҧ�');

    // print.php
    define('_MB_APCAL_COMESFROM', '�o�Өƥ�O�� %s �ҵo���ƥ�C');
}
