...
define('_AM_MYBLOCKSADMIN', 'APCalブロック・グループ管理');
...
define('_AM_FMT_SERVER_TZ_ALL' , 'このサーバの冬季タイムゾーン: %+2.1f<br />このサーバの夏季タイムゾーン: %+2.1f<br />サーバのタイムゾーン名: %s<br />XOOPSでの設定値: %+2.1f<br />APCalでの採用値: %+2.1f<br />') ;
