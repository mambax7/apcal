...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined('APCAL_MB_LOADED')) {
    ...
    // index.php
    define('_MB_APCAL_ERR_NOPERMTOUPDATE', '変更する権限がありません');
    ...
    define('_MB_APCAL_ERR_NOPERMTOINSERT', '登録する権限がありません');
    define('_MB_APCAL_ERR_NOPERMTODELETE', '削除する権限がありません');
    define('_MB_APCAL_ALT_PRINTTHISEVENT', '印刷する');
