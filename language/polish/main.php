...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined('APCAL_MB_LOADED')) {
    ...
    // index.php
    define('_MB_APCAL_ERR_NOPERMTOUPDATE', 'Nie masz uprawnień do zmieniania wydarzeń');
    ...
    define('_MB_APCAL_ERR_NOPERMTOINSERT', 'Nie masz uprawnień do dodawania wydarzeń');
    define('_MB_APCAL_ERR_NOPERMTODELETE', 'Nie masz uprawnień do usuwania wydarzeń');
    define('_MB_APCAL_ALT_PRINTTHISEVENT', 'Wydrukuj to wydarzenie');

    // print.php
    define('_MB_APCAL_COMESFROM', 'To wydarzenie pochodzi od %s');
}
