...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined('APCAL_MB_LOADED')) {
    ...
    // index.php
    define('_MB_APCAL_ERR_NOPERMTOUPDATE', 'Você não tem permissão para mudar eventos');
    ...
    define('_MB_APCAL_ERR_NOPERMTOINSERT', 'Você não tem permissão para criar eventos');
    define('_MB_APCAL_ERR_NOPERMTODELETE', 'Você não tem permissão para excluir eventos');
    define('_MB_APCAL_ALT_PRINTTHISEVENT', 'Imprimir este evento');

    // print.php
    define('_MB_APCAL_COMESFROM', 'Este evento vêm de %s');
