...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined('APCAL_CNST_LOADED')) {
    ...
    define('_APCAL_MB_SUBTITLE_EVENTEDIT', 'Vista de edição');
    ...
    define('_APCAL_MB_LABEL_CHECKEDITEMS', 'Os eventos assinalados são:');
    ...
    define('_APCAL_NTC_MONTHLYBYMONTHDAY', '(Número de entradas)');
    define('_APCAL_NTC_EXTRACTLIMIT', '** Apenas %s eventos são extra��os como máximo');
    ...
    define('_APCAL_CNFM_SAVEAS_YN', 'Você t�� certeza de salvar como outra entrada');
    define('_APCAL_CNFM_DELETE_YN', 'Você t�� certeza de excluir esta entrada?');

    define('_APCAL_ERR_INVALID_EVENT_ID', 'Error: ID do evento não encontrada');
    ...
    define('_APCAL_RR_R_YESRRULE', 'Repetição');
    define('_APCAL_RR_OR', 'or');
    define('_APCAL_RR_S_NOTSELECTED', '-não selecionado-');
