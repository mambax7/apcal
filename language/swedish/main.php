...
// index.php
    define('_MB_APCAL_ERR_NOPERMTOUPDATE', 'Ni har inte rättighet att modifiera händelser');
...
define('APCAL_COPYRIGHT' , '<a href="http://xoops.antiquespromotion.ca" title="Calendar for Xoops" target="_blank">APCal</a> by <a href="http://www.antiquespromotion.ca" title="Antiques Promotion Canada" target="_blank">AP</a>');
    define('_MB_APCAL_ERR_NOPERMTOINSERT', 'Ni har inte rättighet att skapa händelser');
define('_MB_APCAL_ERR_NOPERMTODELETE', 'Ni har inte rättighet att radera händelser');


// Appended by Xoops Language Checker -GIJOE- in 2004-01-14 18:31:01
    define('_MB_APCAL_ALT_PRINTTHISEVENT', 'Skriv ut denna händelse');
    define('_MB_APCAL_COMESFROM', 'Denna händelse kommer från %s');
define('_MB_APCAL_PARMALINK','Länken till denna händelse');
