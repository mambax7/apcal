...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined('APCAL_MI_LOADED')) {
    ...
    define('_MI_APCAL_DESC', 'Módulo de calendario con agenda de eventos');
    ...
    define('_MI_APCAL_BNAME_THEDAYS_DESC', 'Mostrar eventos para el día indicado');
    ...
    define('_MI_APCAL_BNAME_AFTER_DESC', 'Mostrar eventos posteriores al día indicado');
    ...
    define('_MI_APCAL_COMING_NUMROWS', 'Número de eventos en el Bloque de Eventos entrantes');
    ...
    define('_MI_APCAL_SATURDAYCOLOR', 'Color del Sábado');
    define('_MI_APCAL_HOLIDAYCOLOR', 'Color de las vacaciones');
    define('_MI_APCAL_TARGETDAYCOLOR', 'Color del día seleccionado');
    define('_MI_APCAL_SUNDAYBGCOLOR', 'Color de Fondo del Domingo');
    define('_MI_APCAL_WEEKDAYBGCOLOR', 'Color de Fondo of weekday');
    define('_MI_APCAL_SATURDAYBGCOLOR', 'Color de Fondo del Sábado');
    define('_MI_APCAL_HOLIDAYBGCOLOR', 'Color de Fondo de las Vacaciones');
    define('_MI_APCAL_TARGETDAYBGCOLOR', 'Color de Fondo del día seleccionado');
    ...
    define('_MI_APCAL_DAYSTARTFROM', 'L&iacute;mite para separar días');
    ...
    define('_MI_APCAL_DISPLAYCATTITLE', 'Mostar el nombre de la Categoría como Nombre de la p&aacute;gina del m&oacute;dulo');
    define('_MI_APCAL_ENABLESOCIAL', 'Habilitar enlaces a Redes sociales');
    define('_MI_APCAL_NBPICS', 'M&aacute;ximo Número de im&aacute;genes permitidas (0 si no quieres ninguna)');
    ...
    define('_MI_APCAL_ALLCATSCOLOR', 'Color para la categoría por defecto');
    ...
    define('_MI_APCAL_EDITBYGUESTDSC', 'Permisos de agregar eventos por los Invitados');
    ...
    define(
        '_MI_APCAL_DESCUSEURLREWRITE',
        '<b>Para hacerlo funcionar, copia  /modules/APCal/doc/.htaccess a /modules/APCal/.</b><br /><br />Nota: Si no tienes el apache "mod_rewrite" instalado en tu Servidor, es posible que no funcione. Por favor, contacta con tu administrador de sistemas para m&aacute;s detalles.'
    );
    define('_MI_APCAL_WIDERWEEKENDDESC', 'Presiona la Tecla "Ctrl" de tu teclado mientras seleccionas m&aacute;s de un día.');
    ...
    define('_MI_APCAL_OPT_MINI_PHPSELF', 'Página actual');
    ...
    define('_MI_APCAL_ADMENU_CAT', 'Administrador de Categorías');
    define('_MI_APCAL_ADMENU_CAT2GROUP', 'Permisos de Categorías');
    define('_MI_APCAL_ADMENU2', 'Permisos Globales');
    define('_MI_APCAL_ADMENU_TM', 'administración de Tablas');
    ...
    define('_MI_APCAL_ADMENU_MYBLOCKSADMIN', 'Administración de Bloques & Grupos');
    ...
    define('_MI_APCAL_CATEGORY_NOTIFYDSC', 'Opciones de Notificaci&oacute;n aplicables a la categoría actual.');
    define('_MI_APCAL_EVENT_NOTIFY', 'Evento');
    define('_MI_APCAL_EVENT_NOTIFYDSC', 'Opciones de Notificación aplicables al evento actual.');
    ...
    define('_MI_APCAL_CATEGORY_NEWEVENT_NOTIFY', 'Nuevo evento en la categoría');
    define('_MI_APCAL_CATEGORY_NEWEVENT_NOTIFYCAP', 'Notificarme cuando un nuevo evento se ha creado en la Categoría.');
    define('_MI_APCAL_CATEGORY_NEWEVENT_NOTIFYDSC', 'Notificarme con la descripci&oacute;n inclu&iacute;da cuando un nuevo evento es creado in la Categoría.');
    define('_MI_APCAL_CATEGORY_NEWEVENT_NOTIFYSBJ', '[{X_SITENAME}] {X_MODULE} auto-notificaci&oacute;n : Nuevo evento en la Categoría {CATEGORY_TITLE}');
}
