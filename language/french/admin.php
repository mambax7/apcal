...
define( '_AM_NOTICE_SERVER_TZ','Si votre serveur d&eacute;finit les fuseaux horaires  avec l\'heure d\'&eacute;t&eacute; (= sauvegarde &agrave; l\'heure solaire) et que quelques &eacute;v&egrave;nements &eacute;taient enregistr&eacute;s sous APCal 0.6x ou 0.7x, n\'appuyer pas sur ce bouton.<br />eg) Il est naturel d\'afficher les deux -5.0 et -4.0 en EDT (Eastern Daylight Time)');
...
define('_AM_BCACHETIME', 'Dur�e du cache');
define('_AM_ACTION', 'Action');
define('_AM_ACTIVERIGHTS', 'Droits d\'Administration des Modules');
define('_AM_ACCESSRIGHTS', 'Droits d\'acc�s des modules');
